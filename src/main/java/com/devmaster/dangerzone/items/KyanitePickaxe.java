...
public class KyanitePickaxe extends Pickaxe {

    public KyanitePickaxe() {
    ...
    protected ConfigValues getConfigValues() {
        return new ConfigValues(
                DZConfig.getKyanitePickaxeDurability(),
                DZConfig.getKyanitePickaxeDamage(),
                DZConfig.getKyanitePickaxeEfficiency(),
                DZConfig.getKyanitePickaxeAttackSpeed(),
                DZConfig.getKyanitePickaxeHarvestLevel(),
                DZConfig.getKyanitePickaxeEnchantability(),
                DZConfig.getKyanitePickaxeHitCost()
        );
    }
