...
public class KyaniteShovel extends Shovel {

    public KyaniteShovel() {
    ...
    protected ConfigValues getConfigValues() {
        return new ConfigValues(
                DZConfig.getKyaniteShovelDurability(),
                DZConfig.getKyaniteShovelDamage(),
                DZConfig.getKyaniteShovelEfficiency(),
                DZConfig.getKyaniteShovelAttackSpeed(),
                DZConfig.getKyaniteShovelHarvestLevel(),
                DZConfig.getKyaniteShovelEnchantability(),
                DZConfig.getKyaniteShovelHitCost()
        );
    }
